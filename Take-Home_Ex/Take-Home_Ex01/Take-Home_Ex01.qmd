...
I create a new object called **resident_data_clean** where I will rename **PA, SZ** and **Pop** for easy reading by using the <code style="color: blue;">rename()</code> function.
...
With these information, I will be calculating the dependency ratio of the population in Singapore in the different regions. This information will reflect the proportion of individuals who are likely to be economically dependent on others.
