...
From the pie chart, it can be seen that the proportion of male and females in each area is quite proportionate, only differing by 1-2%.

Additionally, the West and North-East Areas made up 25% of the total population, accounting for half the population in Singapore.
