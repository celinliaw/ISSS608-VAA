...
-   What is the proportion of male and females in Singapore and are there different proportions in different Regions in Singapore
...
Additionally, the population in the **Age range of 0 to 29** has consistently **more males that females** in all areas **except in the Central Area.** However, those in the **Age range 30 and above** has **more females than males** in all areas with those aged 60 to 69 in the North area being the exception. However, the pie chart in the previous visualisation shows an equal proportion of males and females in Sing

## 3.3 Bar Graph of Retirees to Working Adults

As the current retirement age is at 68 years old and Singaporeans usually start work around 23 to 25 years old at graduation, we will use the population of those **above 68 years old** over the population of those **Aged 24 to 67** tofind the **ratio of Retirees to working adults.**
...
-   The **Male and Female population in Singapore are similar** with **slightly less males** than females **in all Regions** of Singapore
...
-   There is a good ratio of **1 retiree to 4 working adults** in Singapore, showing a healthy demographic

To conclude, **ggplot2** is a powerful package for exploratory data analysis when paired with **dplyr** which allows mutation of the data to usable formats. The original dataset consists of many areas which is complex to analyse every single one of them, which made me decide to group them into further subgroups for easy reference.

Overall, this exercise was helpful to practice how to present data effectively and to convey a clear message.
