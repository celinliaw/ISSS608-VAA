...
To import csv into R, **read_csv()** function of **readr** package will be used.
...
### 14.4.1 Plotting a static ternary diagram
...
### 14.4.2 Plotting an interactive ternary diagram

The code below is used to create an interactive ternary plot using **plot_ly()** function of **plotly r.**
