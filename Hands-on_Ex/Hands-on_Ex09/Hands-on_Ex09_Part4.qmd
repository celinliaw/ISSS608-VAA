...
By the end of this hands-on exercise, Iwill gain hands-on experience on:
...
Notice that some of the axis labels are too long. The problem will be overcome in the next step.
...
### 17.5.3 Changing the color scheme

We can change the default blue color scheme by using `continuousCS` argument as shown in the code chunk below.
