...
### 18.4.4 Colors in treemap package
...
## 18.6 Designing Interactive Treemap usiing d3treeR

### 18.6.1 Installing d3treeR package

1.  **Install devtools package**
2.  **Load the devtools library and install the package found in github by using the codes below**
...
3.  **Launch d3treeR & treemap package**
